/*
    Preciso de uma função capaz de receber o salário de um funcionário e a sua senioridade atual (junior, pleno ou senior). A função terá que aplicar um bônus confirme a senioridade: junior = R$ 50, pleno = R$ 100 e senior = R$ 1000. A função deve retornar o valor do salário já com o bônus embutido.
...
/*
    Preciso de uma função que seja capaz de permitir que o usuário venda dias de suas férias. Basicamente, os dias de férias são calculados com base no valor bruto do salário mensal (sempre contado como 30, independente da quantidade de dias do mês). Logo, um funcionário que ganha 3000 por mês e quer vender 1 dia de férias, vai receber R$100 pela venda. 
...
export function calcularValorDaVendaDeDiasDeFerias(salarioMensal, diasAVender) {
    // Regras
